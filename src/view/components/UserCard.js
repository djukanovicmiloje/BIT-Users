...
class UserCard extends React.Component{
    ...
    render(){
        ...
        return <div className={userCardClass}>
                <img src={this.state.image} alt=''></img>
                <div>
                <p>{this.state.name}</p>
                <p><i className="fas fa-envelope-square"></i> {this.state.email}</p>
                <p><i className="fas fa-birthday-cake"></i>{this.state.birthdate}</p>
                </div>
            </div>
